from srosignal import srosignal_plot
from srosignal import srosignal_utils 
from srosignal import srosignal_polygon_recog 
...
def poly_extract(
    ...
    polygon_recog = srosignal_polygon_recog.polygon_recog(
    ...
    poly_count = srosignal_plot.poly_plot(polygon_recog.img_raw,
                                         polygon_info_dict,
    ...
    poly_count_dict = poly_count.poly_coord_extract() 
